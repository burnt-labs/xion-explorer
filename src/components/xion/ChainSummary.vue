...
// Import so Vite fingerprints and emits the asset. A literal "/src/assets/..." src
// only resolves off the dev server and 404s in a production build.
...
<template>
  ...
  >
    <div>
      <img class="h-7 w-auto object-contain" :src="veronaLogo" />
    </div>
