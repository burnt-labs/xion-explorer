    ...
    <div
      ...
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          <img class="w-10 h-10"
            src="https://raw.githubusercontent.com/cosmos/chain-registry/master/xion/images/burnt-round.png" />
      ...
      <div class="px-2">
        ...
        <a href="https://twitter.com/burnt_xion" target="_blank"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#373f59]">
        ...
        <a v-if="showDiscord" href="https://discord.com/invite/burnt" target="_blank"
