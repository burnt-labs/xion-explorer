    ...
    <div
      ...
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          ...
          <span class="ml-[8px] translate-y-[4px] rounded-[4px] p-[4px] text-[12px] uppercase bg-base-200"
            :style="`color: ${blockchain.current?.themeColor}`">
            {{
              blockchain.current?.chainName.match("mainnet") ? "mainnet" :
                blockchain.current?.chainName.match("testnet") ? "testnet" :
                  blockchain.current?.chainName.match("devnet") ? "devnet" :
