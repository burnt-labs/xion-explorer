...
const isValidatorOperator = computed(() => {
  const operatorAddress = v.value.operator_address || validator;
  return Boolean(walletStore.currentAddress && walletStore.currentAddress === operatorAddressToAccount(operatorAddress));
});
          ...
          <div class="flex">
            ...
            <div class="mx-2">
              ...
              <StakingActionDialog v-slot="{ open }">
                <button type="button" class="btn btn-primary btn-sm w-full" @click="open(v.operator_address, 'delegate')">
